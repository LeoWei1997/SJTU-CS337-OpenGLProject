#version 330 core
//this shader is for arena and traffic sign, without normals(color = 0.3ambient+0.7diffuse, no specular)
out vec4 FragColor;
...
uniform bool shadows;  // activate shadow or not
...
*/
    // Check whether current frag pos is in shadow
     float shadow = currentDepth -0.006> closestDepth  ? 1.0 : 0.0;
/*
    // PCF
    float shadow = 0.0;
